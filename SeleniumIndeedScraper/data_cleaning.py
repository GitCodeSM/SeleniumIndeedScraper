...
# function to replace strings containing numbers to integer numbers
def to_numeric(x):
    for s in x.split():
        if s.isnumeric():
            return int(s)
...
# data cleaning: improving certain columns to the better usable format
...
# saving the cleaned and formatted dataset
